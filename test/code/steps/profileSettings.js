...
defineSupportCode(({ When, Then }) => {
    ...
    Then('I change my first name', async function () {
        ...
        await this.profileSettingsPage.firstName.setValue(newFirstName).hideDeviceKeyboard();
    ...
    Then('I change my last name', async function () {
        ...
        await this.profileSettingsPage.lastName.setValue(newLastName).hideDeviceKeyboard();
